...
namespace SparkApi.Services
{
    ...
    public class CSVService(IMapper mapper, AppDbContext dbContext)
    {
        ...
        public void ImportNewUserstoDb()
        {
        ...
        public void ImportCsvDatatoDb()
        {
            var data = ExtractCsv<CsvModel>("Data/export.csv");
            ImportNewUserstoDb(); //injecting data as param not working?
            ...
            try
            {
                dbContext.Events.AddRangeAsync(mappedData);
